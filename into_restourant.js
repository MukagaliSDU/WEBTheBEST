function openNav() {
    ...
    document.getElementsByClassName("card")[0].style.backgroundColor = "rgba(0, 0, 0, 0.9)";
  ...
  function closeNav() {
    ...
    document.getElementsByClassName("card")[0].style.backgroundColor = "rgba(255, 255, 255, 0.9)";
